...
<body>
    ...
    <div class="container">
        <div class="isi">
            <h3 style="text-align:center;">DATA PENANAMAN PADA LAHAN {{$lahan->lokasi}} PERIODE {{carbon\carbon::parse($tgl_mulai)->translatedFormat('d F Y')}} SAMPAI {{carbon\carbon::parse($tgl_akhir)->translatedFormat('d F Y')}}</h3>
            <table class="table zero-configuration">
                                            ...
                                            @if($data->isEmpty())
                                                <tr>
                                                    <td colspan="6"> Data pada periode ini tidak ada </td>
                                                </tr>
                                                @else
                                                @foreach($data as $d)
                                                <tr>
