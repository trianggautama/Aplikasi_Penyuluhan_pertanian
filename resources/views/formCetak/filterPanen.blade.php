...
<body>
    ...
    <div class="container">
        <div class="isi">
            <h3 style="text-align:center;">DATA LAHAN PANEN PERIODE {{carbon\carbon::parse($tgl_mulai)->translatedFormat('d F Y')}} SAMPAI {{carbon\carbon::parse($tgl_akhir)->translatedFormat('d F Y')}}</h3>
