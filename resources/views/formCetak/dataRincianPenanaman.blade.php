...
<body>
    ...
    <div class="container"> 
        <div class="isi">
            <h3 style="text-align:center;">DATA RINCIAN PENANAMAN  PADA {{carbon\carbon::parse($penanaman->tanggal)->translatedFormat('d F Y')}} PADA LAHAN {{$penanaman->lahan->lokasi}}</h3>
