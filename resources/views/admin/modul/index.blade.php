    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{Route('modulStore')}}" enctype="multipart/form-data" method="POST">
                    @csrf
                    <div class="form-group">
                        <label for="">Kode Modul</label>
                        <input type="text" name="kode_modul" id="judul" class="form-control" placeholder="Kode Modul">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" name="file" id="foto" class="form-control" required>
                    </div>
