            ...
            <div class="modal-body">
                <form action="{{Route('evaluasiStore')}}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="kode_evaluasi" id="kode_evaluasi" class="form-control"
                            placeholder="Kode Evaluasi">
                    </div>
                    <div class="form-group">
                        <label for="">Nama Evaluasi</label>
                        <input type="text" name="nama_evaluasi" id="nama_evaluasi" class="form-control"
