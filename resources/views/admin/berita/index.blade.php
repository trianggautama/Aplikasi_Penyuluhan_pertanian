                                            ...
                                            <table class="table zero-configuration">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>Pemerintah Kabutan tanah Laut melaksanakan penyuluhan pertanian dengen peserta dari adalah petani ...</td>
                                                        <td>12 Mei 2020</td>
                                                        <td>Tri Angga</td>
                                                        <td>
                                                            <a href="{{Route('beritaShow')}}" class="btn btn-icon btn-primary"><i class="feather icon-info"></i></a>
                                                            <a href="{{Route('beritaEdit')}}" class="btn btn-icon btn-warning"><i class="feather icon-edit"></i></a>
